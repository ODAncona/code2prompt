...
3.  📦 Install the dependencies :
    ...
    `uv` creates `.venv`, locks the development dependencies, and builds the native extension in editable mode.
...
4.  🧪 Run the tests :
    ...
    Run the project's test command in the synchronized environment.
